...
<input type="text" name="search" id="search" class="form-control" placeholder="Search contractor Data" />
...
<td><input type="submit" name="submit">request</td>
...
$(document).ready(function(){
 ...
 fetch_contractor_data();

 function fetch_contractor_data(query = '')
 {
  $.ajax({
   url:"{{ route('Viewcontractor.action') }}",
   method:'GET',
   data:{query:query},
   dataType:'json',
