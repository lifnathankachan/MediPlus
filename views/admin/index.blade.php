                    ...
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li class="nav-item">
                            ...
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="contractoraprove" class="dropdown-item">Approve Contractor</a>
                                <a href="viewcontractor" class="dropdown-item">View Contractor</a>
                                <a href="#" class="dropdown-item">Analytics</a>
                                <a href="#" class="dropdown-item">Widgets</a>
                            </div>
                        </li>
                        <!-- <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-envelope"></i> <span class="mini-dn">Mailbox</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                ...
                                <a href="#" class="dropdown-item">View Mail</a>
                                <a href="#" class="dropdown-item">Compose Mail</a>
                            </div>
                        </li>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Add Category <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="dashboard.html">Add category </a>
                                                </li>
            ...
            <div class="login-form-area mg-t-30 mg-b-40">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <form id="adminpro-form" class="adminpro-form" action="/add" method="post">
                        @csrf
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-button-pro">
                                                <button type="submit" class="login-button login-button-rg">Add</button>
