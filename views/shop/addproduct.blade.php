		...
		<!-- header-starts -->
								...
								<!--custom-widgets-->
                                                ...
                                                <div class="col-md-6 graph-2">
																					...
																					<div class="grid-1">
                                                                                            ...
                                                                                            <form action="/addproduct" method="POST" class="form-horizontal oh-autoval-form" enctype="multipart/form-data" onsubmit="return">@csrf
																																																<div class="form-group"> <label for="name" class="col-sm-2 control-label">Product Name</label>
                                                                                                        <div class="col-sm-9"> <input type="text" autocomplete="off" class="form-control av-name" av-message="Invalid name" id="inputEmail3" placeholder="product Name" name="pname" required=""> 
                                                                                                        </div> 
                                                                                                        </div>
																																																				
                                                                                                        <div class="form-group"> <label for="quantity" class="col-sm-2 control-label">Quantity</label>
                                                                                                        <div class="col-sm-9"> <input type="text"  autocomplete="off" class="form-control av-posnumber" id="inputEmail3" placeholder="quantity" name="quantity" required=""> 
                                                                                                        </div> 
                                                                                                        </div>
																																																				<br>

                                                                                                        <div class="form-group"> <label for="image" class="col-sm-2 control-label">Image</label>
                                                                                                        <div class="col-sm-9"> <input type="file" autocomplete="off" class="form-control av-image" id="inputEmail3" placeholder="image" name="image" required=""> 
                                                                                                        </div> 
                                                                                                        </div>
																																																				<br>
                                                                                                        <div class="form-group"> <label for="price" class="col-sm-2 control-label">Actual price</label>
                                                                                                        <div class="col-sm-9"> <input type="text" autocomplete="off" class="form-control av-posnumber" id="inputEmail3" placeholder="actual price" name="price" required=""> 
                                                                                                        </div> 
                                                                                                        </div>
																																																				<div class="form-group"> <label for="price" class="col-sm-2 control-label">Manufacture date</label>
                                                                                                        <div class="col-sm-9"> <input type="date" autocomplete="off" class="form-control av-date" id="inputEmail3" placeholder="mdate" name="manufacture_date" required=""> 
                                                                                                        </div> 
                                                                                                        </div>
																																																				<div class="form-group"> <label for="price" class="col-sm-2 control-label">Expiry Date</label>
                                                                                                        <div class="col-sm-9"> <input type="date" autocomplete="off" class="form-control av-date" id="inputEmail3" placeholder="xdate" name="expiration_date" required=""> 
                                                                                                        </div> 
                                                                                                        </div>
																																																				
																																																				<div class="form-group"> <label for="price" class="col-sm-2 control-label">Stock Availability</label>
                                                                                                        <div class="col-sm-9"> <input type="text" autocomplete="off" class="form-control av-date" id="inputEmail3" placeholder="xdate" name="stock" required=""> 
                                                                                                        </div> 
                                                                                                        </div>	
                                                                                                       ...
                                                                                                       <br>
                                                                                                           ...
                                                                                                           <div class="col-sm-offset-2"> <button type="Submit" class="btn btn-default">Submit</button> 
                                                                                                           
																																																					 </div> 
                                                                                                           </form> 

															
																	<script type="text/javascript" src="seller/js/protovis-d3.2.js"></script>
																	<script type="text/javascript" src="seller/js/vix.js"></script>
			...
			<!--/down-->
							<div class="down">	
									...
									<li><a class="tooltips" href="/update"><span>Update Profile</span><i class="fa fa-bell-o"></i></a></li>
                                ...
                                <a href="{{ route('logout') }}" onclick="event.preventDefault();
                                            ...
                                            <form id="logout-form" action="{{ route('logout') }}" method="post" class="lnr lnr-power-switch" style="display: none;">
                                                @csrf
                                            </form>
                                </li>
