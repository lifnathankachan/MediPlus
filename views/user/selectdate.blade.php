...
<html lang="en">
    ...
    <body>
		...
		<div class="container-login100" style="background-image: url('{{ asset('logtem/images/bg-01.jpg')}}');" >
                    <form action="/selectdatez" method="post">
            ...
            <br>
              ...
              start date    <input type="date" name="start_date" id="datepicker" placeholder="Pick a Date" min="<?php echo $today; ?>" required>
                        <br><br>
                   end date     <input type="date" name="end_date" id="datepicker" placeholder="Pick a Date" min="<?php echo $today; ?>"  required>
