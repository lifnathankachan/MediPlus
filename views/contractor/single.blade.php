...
<div class="banner-bootom-w3-agileits">
	...
	<div class="container">
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
					...
					<ul class="slides">
						...
						<div>   <img src="/images/{{$row->image}}" id="profile-img-tag2" style="width:300px; height:250px;"/></div>
                        </li>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price">Rs.{{$row->price}}</span> </p>
					<div class="rating1">
					...
					<div class="color-quality">
						...
						<form action="{{url('/cart/'.$row->p_id)}}" method="post">@csrf
						<input type="hidden"  name="p_id" value="{{$row->p_id}}">
				
							<h5>Availability :{{$row->stock}} Stocks</h5>
						<br>
					
						
<!-- 					
						<h5>Description :{{$row->quantity}} Quantity</h5> -->
						<br>
				
						<h5>No of Quantity : <input type="number" min="1" max="100" required autocomplete="off" name="qty" id="quan" value="" onChange="copy()"/></h5>
						
					
						
				
																	
						<input type="hidden"id="pr"  name="actualprice" value="{{$row->price}}">
					   <input type="hidden" id="tot" name="totalprice" value="{{$row->price}}">
