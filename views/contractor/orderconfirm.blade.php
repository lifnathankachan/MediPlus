...
// $st=DB::select("select * from tbl_order,tbl_product where tbl_order.p_id=tbl_product.p_id and tbl_order.contractor_id='$unm' and tbl_order.status=2"); 

// $count = 1;
$st=DB::select("select * from  tbl_product,tbl_cart where tbl_product.p_id=tbl_cart.p_id and tbl_cart.contractor_id" ); 
$count = 1;
?>
...
@foreach($st as $row)
				<?php $total += $row->totalprice; ?>
						<ul>
							...
							<input type="hidden" value="{{$row->shop_id}}">
								<i>-</i>
                   ...
                   // $st=DB::select("select * from tbl_cart,tbl_product where tbl_cart.p_id=tbl_product.p_id and tbl_cart.userid='$unm'"); 
						...
						<form action="/payment" method="post" class="creditly-card-form agileinfo_form">@csrf
							<section class="creditly-wrapper wrapper">
								<div class="information-wrapper">
									<div class="first-row form-group">
										...
										<!-- <input type="hidden"  name="userid" value="{{Session::get('email')}}"/> -->
										<input type="hidden"  name="seller_id" value="{{$row->shop_id}}"/>
										...
										<div class="card_number_grids">
											<div class="card_number_grid_left">
												<div class="controls">
													...
													<input class="form-control" name="mob" type="text" placeholder="Mobile number">
												</div>
											</div>
